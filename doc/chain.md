...
|*mult(C1, C2)*| Умножение конечных цепных дробей на меньше (*C1* * *C2*)|  
|*division(C1, C2)*(| Деление конечных цепных дробей на меньше (*C1* / *C2*)|  
|*add(C1, C2)*| Сложение конечных цепных дробей на меньше (*C1* + *C2*)|  
|*sub(C1, C2)*| Вычитание конечных цепных дробей на меньше (*C1* + *C2*)|  
