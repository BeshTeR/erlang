...
%% API
-export([gcd/2, sign/1, pow/2, fac/1, mult/2, id/1, pmap/2, pcall/1, flush/0, on_exit/2, type_of/1, count_msg/1, depth/1, map_all/2, pmap_all/2]).
...
pmap_all(_, []) -> [];
pmap_all(F, L) ->
    lib:pmap(fun(X) -> pmap_all(F, X) end, L).
